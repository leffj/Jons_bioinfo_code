...
import unittest
import demultiplex_seqs as testing_code
import os
import shutil
...
class test_case(unittest.TestCase):
	# test cases for demultiplex_seqs.py
	def setUp(self):
		seqs, revSeqs, barcodes, mapping, output_dir = testing_code.setup(
		...
		rc = False
		testing_code.demultiplex(mapping, seqs, barcodes, revSeqs, output_dir, rc)
